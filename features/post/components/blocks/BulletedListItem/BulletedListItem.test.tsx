import { createMockBulletListBlock as createMockBlock } from '@/shared/testing/fixture';
import { BulletedListItem } from '@/features/post/components/blocks/BulletedListItem/BulletedListItem';
