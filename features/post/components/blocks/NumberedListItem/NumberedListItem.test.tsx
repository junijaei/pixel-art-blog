import { createMockNumberListBlock as createMockBlock } from '@/shared/testing/fixture';
import { NumberedListItem } from '@/features/post/components/blocks/NumberedListItem/NumberedListItem';
