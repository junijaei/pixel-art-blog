import { uploadCoverImage, uploadImage } from '@/features/media/lib/api';
import { batchSetCachedImages, getCachedImage, setCachedImage } from '@/features/media/lib/cache';
import { isDevelopment, mockProcessBlocks } from '@/features/media/lib/dev-mock';
import type { ImageProcessingStats, ImageUploadResult } from '@/features/media/model';
import type { ImageBlock } from '@/features/post/model/content/block';
import { extractImageUrl } from '@/features/post';
