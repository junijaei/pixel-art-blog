...
vi.mock('@/features/media/lib/dev-mock', () => ({
  isDevelopment: vi.fn(() => false),
  mockProcessBlocks: vi.fn(),
}));

vi.mock('@/features/media/lib/cache', () => ({
  getCachedImage: vi.fn(),
  batchSetCachedImages: vi.fn(),
}));

vi.mock('@/features/media/lib/api', () => ({
  uploadImage: vi.fn(),
}));
...
import { batchSetCachedImages, getCachedImage } from '@/features/media/lib/cache';
import { uploadImage } from '@/features/media/lib/api';
import { processImageBlocks } from '@/features/media/lib/processor';
